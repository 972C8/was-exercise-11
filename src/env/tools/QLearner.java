...
public class QLearner extends Artifact {
  ...
  public void calculateQ(Object[] goalDescription, Object episodesObj, Object alphaObj, Object gammaObj,
    ...
    // Get all compatible states of the goal description and initialize the Q-table
    List<Integer> compatibleStates = lab.getCompatibleStates(Arrays.asList(goalDescription));
    double[][] qTable = initializeQTable();

    // Learn for the specified number of episodes
    for (int episode = 0; episode < episodes; episode++) {

      System.out.println("-------------------------------");
      System.out.println("START NEW EPISODE #" + episode);
      System.out.println("-------------------------------");
      ...
      while (!compatibleStates.contains(lab.readCurrentState())) {
        ...
        // Make console output more readable when looping
        System.out.println("-------------------------------");
        ...
        System.out.println("Updated the Q-Table: qTable[" + currentState + "][" + bestAction + "]: " + qTable[currentState][bestAction]);
    ...
    // Re-randomize environment if working with simulated lab, or else the goal state is already reached next time
